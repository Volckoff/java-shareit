...
//        when(itemService.getItemById(anyLong())).thenReturn(testItemOwner);
//
...
//    }
    ...
    void createItemWithValidRequestShouldReturnCreatedItem() throws Exception {
        when(itemService.addItem(any(NewItemRequest.class), anyLong())).thenReturn(testItem);
        ...
        verify(itemService).addItem(any(NewItemRequest.class), anyLong());
    }
    ...
    void searchItemsByTextShouldReturnListOfItems() throws Exception {
        when(itemService.getItemsByText(anyString())).thenReturn(List.of(testItem));
        ...
        verify(itemService).getItemsByText(anyString());
    }

    @Test
    void createCommentShouldReturnCreatedComment() throws Exception {
        when(itemService.addComment(anyLong(), any(CommentDto.class), anyLong())).thenReturn(testComment);
